...
export default function HerPride() {
    ...
    return (
        <div className='xs:overflow-x-hidden sm:overflow-x-hidden md:overflow-x-hidden '>
            <div className="h-screen xl:h-auto 2xl:h-auto">
                <Navbar />
                <div className="mt-20 casestudy-container xl:flex xl:items-start 2xl:flex 2xl:items-start p-5 md:px-0 lg:px-0 xl:p-5 2xl:p-5 h-fit ">
                    {/* Sidebar */}

                    <div className="case-study-sidebar sticky z-30 bg-white hidden md:pb-2 lg:pb-2 md:w-full md:top-[80px] lg:top-[60px] xl:top-[100px] 2xl:top-[100px]  md:block lg:block xl:block 2xl:block xl:bg-transparent 2xl:bg-transparent">
                        <div className="sidebar-links relative ">
                            <div className="absolute bottom-0 left-0  xl:right-0 xl:top-0 2xl:right-0 2xl:top-0 md:w-full lg:w-full md:h-[5px] lg:h-[5px] xl:h-full 2xl:h-full md:border-b-[4px] lg:border-b-[4px] xl:border-r-[4px] 2xl:border-r-[4px]  border-[#E3E3E3]"></div>

                            <ul className="text-[12px] text-right text-nowrap relative flex xl:flex-col 2xl:flex-col">
                                {sections.map((section) => (
                                    <li
                                        key={section.id}
                                        className={`relative flex justify-center mx-0 lg:mx-2 text-center md:py-4 lg:py-4 xl:px-4 2xl:px-4 xl:my-4 2xl:my-4 ${activeSection === section.id
                                            ? 'text-[#000000] font-medium'
                                            : 'font-medium text-[#000000] opacity-50'
                                            }`}
                                    >
                                        {activeSection === section.id && (
                                            <div className="absolute bottom-0 w-[25px] h-[5px] xl:top-0 2xl:top-0 xl:right-0 2xl:right-0 xl:h-full xl:w-[4px] 2xl:h-full 2xl:w-[4px] rounded-t-xl rounded-b-xl  bg-[#015A58] "></div>
                                        )}

                                        <a href={`#${section.id}`} className="hover:text-[#015A58] md:text-wrap ">
                                            {section.label}
                                        </a>
                                    </li>
                                ))}
                    ...
                    <div className="case-study-content md:px-5 lg:px-5 xl:ml-10 2xl:ml-10">
                        <section id="ProjectOverview" className="">
                            <h1 className='text-[30px] lg:text-nowrap xl:text-nowrap 2xl:text-nowrap   lg:text-[40px] xl:text-[40px] 2xl:text-[40px] text-[#015A58] text-center mt-5 lg:mb-5 xl:mb-5 2xl:mb-5'>Creative Approach to Borrowing & Loan Management</h1>
                            <img src={afcHome} alt="Overview" />

                            <div className="mt-10">
                                <p className='text-wrap lg:text-nowrap xl:text-nowrap 2xl:text-nowrap font-medium text-[#015A58] text-center lg:text-left xl:text-left 2xl:text-left text-[25px] lg:text-[30px] xl:text-[30px] 2xl:text-[30px]'>Project Overview</p>
                                <p className='text-justify  lg:text-left xl:text-left 2xl:text-left font-normal leading-6 text-[14px] '>
                        ...
                        <section id="MyRoleAndDesignProcess" className="mt-14">
                            <p className='text-wrap lg:text-nowrap xl:text-nowrap 2xl:text-nowrap font-medium text-[#015A58] text-center lg:text-left xl:text-left 2xl:text-left text-[25px] lg:text-[30px] xl:text-[30px] 2xl:text-[30px]'>My Role & Design Process</p>

                            <div className="flex flex-col-reverse lg:flex-row xl:flex-row 2xl:flex-row justify-between mt-5">
                                ...
                                <img src={designProcess} alt="Research and Insights" className=' mb-4 lg:mb-0 xl:mb-0 2xl:mb-0  lg:w-[70%] lg:h-[70%] xl:w-[70%] xl:h-[70%] 2xl:w-[70%] 2xl:h-[70%]' />
                            </div>
                        ...
                        <section id="ResearchAndInsights" className="mt-14">
                            ...
                            <p className='text-wrap lg:text-nowrap xl:text-nowrap 2xl:text-nowrap font-medium text-[#015A58] text-center lg:text-left xl:text-left 2xl:text-left text-[25px] lg:text-[30px] xl:text-[30px] 2xl:text-[30px]'>Research & Discovery</p>
                            <p className='text-justify  lg:text-left xl:text-left 2xl:text-left font-normal leading-6 text-[14px]'>
                            ...
                            <div className="mt-10">
                                <p className='text-wrap lg:text-nowrap xl:text-nowrap 2xl:text-nowrap font-medium text-[#015A58] text-center lg:text-left xl:text-left 2xl:text-left text-[25px] lg:text-[30px] xl:text-[30px] 2xl:text-[30px]'>User Personas</p>
                                <img src={personaOne} alt="User persona" className='lg:w-[70%] xl:w-[70%] 2xl:w-[70%] mt-5' />
                                <img src={personaTwo} alt="User persona" className='lg:w-[70%] xl:w-[70%] 2xl:w-[70%] mt-5' />
                            </div>
                            <div className='mt-10'>
                                <p className='text-wrap lg:text-nowrap xl:text-nowrap 2xl:text-nowrap font-medium text-[#015A58] text-center lg:text-left xl:text-left 2xl:text-left text-[25px] lg:text-[30px] xl:text-[30px] 2xl:text-[30px]'>User Flow - User Type 1</p>
                                <img src={userFlow} alt="User persona" className='lg:w-[90%] xl:w-[90%] 2xl:w-[90%] mx-auto mt-5' />
                            </div>
                        </section>

                        <section id="CompetitiveAnalysis" className="mt-14">
                            <p className='text-wrap lg:text-nowrap xl:text-nowrap 2xl:text-nowrap font-medium text-[#015A58] text-center lg:text-left xl:text-left 2xl:text-left text-[25px] lg:text-[30px] xl:text-[30px] 2xl:text-[30px]'>Competitive Analysis</p>
                            <p className='text-justify  lg:text-left xl:text-left 2xl:text-left font-normal leading-6 text-[14px] mt-3'>
                            ...
                            <p className='text-justify  lg:text-left xl:text-left 2xl:text-left font-normal leading-6 text-[14px] mt-5'>
                            ...
                            <img src={CompetitiveAnalysis} alt="Competitive analysis" className='lg:w-[60%] xl:w-[60%] 2xl:w-[60%] mt-5' />
                        </section>

                        <section id="UIDesignsUserType1" className="mt-14">
                            <p className='text-wrap lg:text-nowrap xl:text-nowrap 2xl:text-nowrap font-medium text-[#015A58] text-center lg:text-left xl:text-left 2xl:text-left text-[25px] lg:text-[30px] xl:text-[30px] 2xl:text-[30px]'>User Type One (Cooperative Members) UI Screens</p>
                            <img src={afcOnboarding} alt="UI Designs - User Type 1" className=' mt-5' />

                            <div className="image-grid mt-8 grid grid-cols-2 gap-4 lg:gap-x-0 xl:gap-x-0 2xl:gap-x-0 lg:gap-y-8 xl:gap-y-8 2xl:gap-y-8 items-center">
                                {afcUserImages.map((image, index) => (
                                    <div key={index} className="">
                                        <img src={image} alt={`case-study-${index}`} className='w-full lg:max-w-[80%] xl:max-w-[80%] 2xl:max-w-[80%] ' />
                                    </div>
                                ))}
                            </div>
                        </section>
                        ...
                        <section id="UIDesignsUserType2" className="mt-14">
                            <p className='text-wrap lg:text-nowrap xl:text-nowrap 2xl:text-nowrap font-medium text-[#015A58] text-center lg:text-left xl:text-left 2xl:text-left text-[25px] lg:text-[30px] xl:text-[30px] 2xl:text-[30px]'>User Type Two (Cooperative Admin) UI Screens</p>
                            <img src={afcMain} alt="UI Designs - User Type 2" className=' mt-5' />

                            <div className="image-grid mt-8 grid grid-cols-2 gap-4 lg:gap-x-0 xl:gap-x-0 2xl:gap-x-0 lg:gap-y-8 xl:gap-y-8 2xl:gap-y-8">
                ...
                <div className="landing-section h-[400px] bg-cover bg-center bg-no-repeat flex">
                    <div className=" w-full h-full bg-gradient-to-b from-[#000000D9] to-[#002F2ED9] p-12 flex items-center justify-center">
                        ...
                        <div className='text-center'>
                            ...
                            <p className="text-white text-[30px] lg:text-[40px] xl:text-[40px] 2xl:text-[40px] font-medium text-wrap md:text-nowrap lg:text-nowrap xl:text-nowrap 2xl:text-nowrap mt-10">Pride Mobile Application</p>
                            <button
                                onClick={handleClick}
